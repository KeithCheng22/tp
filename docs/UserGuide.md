...
|--------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **`n/NAME`**             | Name of the contact. Only accepts alphanumeric characters, with max of 1 space between words.<br> e.g., `n/James Ho`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
Certain columns in the table (that may contain long entries) can be manually resized to fit the length of the entry. If the entry is still too long, it will be truncated with '...'.
...
* Extraneous parameters for commands that do not take in parameters (such as `help`, `list`, `exit` and `clear`) invalidates commands.<br>
  e.g. if the command specifies `help 123`, an error will be thrown.
